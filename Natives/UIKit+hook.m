...
BOOL UIKitHasLiquidGlass(void) {
    typedef BOOL (*UISolariumEnabledFunc)(void);
    static UISolariumEnabledFunc solariumEnabled;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        solariumEnabled = (UISolariumEnabledFunc)dlsym(RTLD_DEFAULT, "_UISolariumEnabled");
    });
